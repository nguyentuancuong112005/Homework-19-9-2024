        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    Date borrowDate = new Date(); // For simplicity
                ...
                case 3:
                    ...
                    if (personToUpdate != null) {
                        // Update logic can be added here based on specific requirements
                        System.out.println("Person found: " + personToUpdate.getFullName());
                    } else {
                        System.out.println("Person not found with ID: " + idToUpdate);
                    }
                    break;
